...
map:
    ...
    # THINK: why a0? A: Prepare the argument load
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why).
    # What function? Recall the parameters of "map" A: s1 has store the address of the function.
    jalr ra, s1, 0
    ...
    # THINK: why a1? What about a0? A: last statement has done to a0.
    mv a1, s1
